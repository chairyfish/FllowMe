...
/*
        MyAdapter adapter = new MyAdapter(getActivity(),
				LinkRouteActivity.curDirections);
...
*/
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        LinkRouteActivity.mDrawerLayout.closeDrawers();
        if (isSoundOn)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.direction:
                if (LinkRouteActivity.mDrawerLayout.isDrawerOpen(GravityCompat.END)) {
                    LinkRouteActivity.mDrawerLayout.closeDrawers();
                } else {
                    LinkRouteActivity.mDrawerLayout.openDrawer(GravityCompat.END);
                }
                return true;
