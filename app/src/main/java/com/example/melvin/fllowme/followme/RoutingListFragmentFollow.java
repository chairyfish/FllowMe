 ...
 */
public class RoutingListFragmentFollow extends Fragment implements
...
/*
        MyAdapterFollow adapter = new MyAdapterFollow(getActivity(),
				FollowMeActivity.curDirections);
...
*/
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        FollowMeActivity.mDrawerLayout.closeDrawers();
        if (isSoundOn)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.direction:
                if (FollowMeActivity.mDrawerLayout.isDrawerOpen(GravityCompat.END)) {
                    FollowMeActivity.mDrawerLayout.closeDrawers();
                } else {
                    FollowMeActivity.mDrawerLayout.openDrawer(GravityCompat.END);
                }
                return true;
