...
package com.example.melvin.fllowme.followme;
...
public class FollowMeActivity extends Activity implements
        RoutingListFragmentFollow.onDrawerListSelectedListener,
        RoutingDialogFragmentFollow.onGetRoute {
    ...
    Point point1 = new Point(-120.278, 37.496);
    Point point2 = new Point(-120.334, 37.232);
    Point point3 = new Point(-120.364, 37.245);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        directionsLabel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ListView lv = RoutingListFragmentFollow.mDrawerList;
        ...
        img_getDirections.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RoutingDialogFragmentFollow frag_dialog = new RoutingDialogFragmentFollow();
...
//        dialog.dismiss();
        ...
        if (mResults == null) {
            //      Toast.makeText(FollowMeActivity.this, mException.toString(),
        ...
        if (fm.findFragmentByTag("Nav Drawer") == null) {
            FragmentTransaction ft = fm.beginTransaction();
            RoutingListFragmentFollow frag = new RoutingListFragmentFollow();
...
/*
    ...
    private class MyTimerTask extends TimerTask {
        public void run() {
            FollowMeActivity.timerHandler.sendEmptyMessage(0);
        }
    }
    ...
    public class TimerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            clearAll();
            point1.setX(point1.getX() + 0.001);
            point1.setY(point1.getY() + 0.002);
            QueryDirections(mLocation, point1);
        }
    }
